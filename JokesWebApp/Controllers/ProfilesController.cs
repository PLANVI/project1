...
namespace JokesWebApp.Controllers
{
    public class ProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,login,Name,Age")] Profile profile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddValue([Bind("Id,login,Name,Age")] Profile profile, UserManager<IdentityUser> UserManager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,login,Name,Age")] Profile profile)
        {
            if (id != profile.Id)
            {
                return NotFound();
